...
<div class="row w3-res-tb">
    ...
    <!-- Button trigger modal -->
        @can('transportFee-add')
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addTransportFreeModal">Add</button>
        @endcan
    </div>
</div>
...
<!-- Modal add-->
@include('admin.Transport_fee.add')
<!-- Modal edit-->
...
<script src="{{ asset('admins/transportFee/add/add.js') }}"></script>
<script src="{{ asset('admins/transportFee/index/index.js') }}"></script>
<script src="{{ asset('admins/transportFee/edit/edit.js') }}"></script>
