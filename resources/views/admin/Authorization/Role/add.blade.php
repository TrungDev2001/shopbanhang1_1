...
<div class="table-agile-info">
    <div>
        ...
        <div class="row w3-res-tb" style="background: #ffffff; border-radius: 15px; padding: 15px; margin: auto; margin-top: 15px; width: 980px; padding: 55px;">
            <form action="{{ route('RoleController.store') }}" id="productAdd" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="descriptionAdd"  id="Description"  data-validation="required" data-validation-error-msg="Email không được để trống" placeholder="Enter email" value={{ old('emailAdd') }}>
                </div>
                                ...
                                <div class="row" style="padding-left: 96px;">
                                    @foreach ($permission->permissionChildren as $key => $permissionChildren_item)
                                        <div class="form-check form-check-inline col-md-3">
                                            <input class="form-check-input checkboxChildren" type="checkbox" id="inlineCheckbox" value="{{ $permissionChildren_item->id }}" name="permission[]">
